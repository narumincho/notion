 ...
 */
export function commentIdFrom(id: string): CommentId {
 ...
 * @throws {Error} IDとして解釈できない文字列が渡された場合
 */
export function blockIdFrom(id: string): BlockId {
 ...
 * @throws {Error} IDとして解釈できない文字列が渡された場合
 */
export function pageIdFrom(id: string): PageId {
 ...
 * @throws {Error} IDとして解釈できない文字列が渡された場合
 */
export function databaseIdFrom(id: string): DatabaseId {
 ...
 * @throws {Error} IDとして解釈できない文字列が渡された場合
 */
export function userIdFrom(id: string): UserId {
 ...
 * @throws {Error} IDとして解釈できない文字列が渡された場合
 */
export function selectIdFrom(id: string): SelectId {
 ...
 * データベースのプロパティのセレクトの選択肢のIDを文字列から作成する
 */
export function propertyIdFrom(id: string): PropertyId {
  if (typeof id !== "string") {
